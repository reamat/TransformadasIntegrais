...
x'(0)&=& 0\\
\end{eqnarray*}
 \indent  {a)}  Calcule a transformada de Laplace $X(s)=\mathcal{L}\{x(t)\}$.
\indent  {b)}  Calcule a transformada inversa e escreva $x(t)$.
\indent  {c)} Aplique sua solução do item b) nas condições inciais.\\
