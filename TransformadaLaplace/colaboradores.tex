...
\begin{center}
  \url{https://github.com/reamat/TransformadasIntegrais/graphs/contributors}
\end{center}

Para saber mais como participar, visite o site oficial do projeto:
\begin{center}
  \url{https://www.ufrgs.br/reamat/TransformadasIntegrais}
\end{center}
ou comece agora mesmo visitando nosso repositório GitHub:
\begin{center}
  \url{https://github.com/reamat/TransformadasIntegrais}
\end{center}