...
\begin{exer} Considere os diagramas de espectro de magnititudes das função $f(t)$. Sabendo que $f(t)$ representa uma função real (i.e., diagrama de especto de magnitudes par), calcule uma estimativa para a energia total dada por $E:=\int_{-\infty}^\infty |f(t)|^2dt$:
...
\begin{exer} Considere os diagramas de espectro de magnititudes das função real $f(t)$. Defina $g(t)$ como $g(t)=f'(t)$.
