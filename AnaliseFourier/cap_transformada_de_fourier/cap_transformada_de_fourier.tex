...
\includegraphics[width=\textwidth]{cap_transformada_de_fourier/pics/figura_2}\vspace{10pt}
\includegraphics[width=\textwidth]{cap_transformada_de_fourier/pics/figura_3}\end{center}
...
Observemos os diagramas de especto para $f_T(t)$ multiplicado por $T$ quando $T=2$, $T=4$ e $T=8$ na figura \ref{dia_espc_tenda}.
 \begin{figure}[!ht]
\includegraphics[width=\textwidth]{cap_transformada_de_fourier/pics/figura_4}
\includegraphics[width=\textwidth]{cap_transformada_de_fourier/pics/figura_5}
\includegraphics[width=\textwidth]{cap_transformada_de_fourier/pics/figura_6}\caption{\label{dia_espc_tenda}}
\end{figure}
 \end{ex}
