...
\begin{exer}No exemplo \ref{ex_eq_dif_2}, mostre que a solução satisfaz a condição inicial: 
\begin{equation}
\lim_{t\to 0}u(x,t)=\frac{Q}{A}\delta(x-x_0)
\end{equation}
isto é:
\begin{itemize}
\item[i.]$\displaystyle\int_{-\infty}^\infty u(x,t)dx := \frac{Q}{A}, ~~\forall t>0,$
\item[ii.]$\displaystyle\lim_{t\to 0+}u(x,t)=0,~~\forall x\neq x_0,$
\item[iii.]$\displaystyle\lim_{t\to 0+}u(x_0,t)=\infty,~~\forall x\neq x_0.$
\end{itemize}

Além disso, verique os limites para infinito são nulos:
\begin{equation}
...
\begin{exer} Enconte a solução da equação da onda dada
\begin{eqnarray*}
